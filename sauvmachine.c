...
bool chargerJeumch(char board[], int *joueurActuel, int *PionRestX, int *PionRestO, int *movesX, int *movesO, int *moulinsX, int *moulinsO, char nomJoueur[]) {
    FILE *fichier = fopen(FICHIER_SAUVEGARDE1, "r");
    if (fichier == NULL) {
...
void sauvegarderJeumch(char board[], int joueurActuel, int PionRestX, int PionRestO, int movesX, int movesO, int moulinsX, int moulinsO, char nomJoueur[]) {
    FILE *fichier = fopen(FICHIER_SAUVEGARDE1, "w");
    if (fichier == NULL) {
